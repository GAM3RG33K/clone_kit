...
import 'package:clone_kit/src/command_runner.dart';
...
void main() {
  group('CloneKitCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late CloneKitCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = CloneKitCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = CloneKitCommandRunner();
